...
// /// attached to a spring and damper configured with a large constant</item>
// /// </list>
// ///
...
//         // Apply Perlin noise
//         float noiseX = (Mathf.PerlinNoise(Time.time * 0.1f, 0) - 0.5f) * 2 * perlinNoiseIntensity;
//         float noiseY = (Mathf.PerlinNoise(Time.time * 0.1f, 1) - 0.5f) * 2 * perlinNoiseIntensity;
//         float noiseZ = (Mathf.PerlinNoise(Time.time * 0.1f, 2) - 0.5f) * 2 * perlinNoiseIntensity;
