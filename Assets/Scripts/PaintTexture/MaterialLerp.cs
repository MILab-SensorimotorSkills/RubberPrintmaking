...
public class MaterialLerp : MonoBehaviour
{
    ...
    // private Texture2D inSideTexture;
    ...
    //     if(canvasRenderer.material.mainTexture == null || canvasRenderer.material.subTexture == null){
    //         if(canvasRenderer.material.mainTexture == null){
    //             canvasTexture = new Texture2D(textureSizeX, textureSizeY);
    //         }
    //         if(canvasRenderer.material.subTexture == null){
    //             canvasTexture.material.subTexture = new Texture2D(textureSizeX, textureSizeY);
    //         }
    //     }else{
    //         if(canvasRenderer.material.mainTexture is Texture2D){
    //             outSideTexture = (Texture2D)canvasRenderer.material.mainTexture;
    //             textureSizeX = outSideTexture.width;
    //             textureSizeY = outSideTexture.height;
    //             canvasTexture = new Texture2D(outSideTexture.width, outSideTexture.height);
    //             canvasTexture.SetPixels32(outSideTexture.GetPixels32());
    //             canvasTexture.Apply();
    //         }else{
    ...
    //         if (pixx >= 0 && pixy >= 0 && pixx < textureSizeX && pixy < textureSizeY)
    //         {
    //             canvasTexture.SetPixel(pixx, pixy, outSideTexture.GetPixel(pixx, pixy));
    //             //**Debug.Log("Pixel set at ("+pixx+", "+pixy+")");
    //         }
    //     }
    //     canvasUpdateRequired = true;
